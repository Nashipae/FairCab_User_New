...
import com.faircab.user.common.RecyclerItemClickListener;
import com.faircab.user.data.network.model.Address;
import com.faircab.user.data.network.model.AddressResponse;
import com.faircab.user.data.network.model.AddedStop;
import com.faircab.user.ui.adapter.PlacesAutoCompleteAdapter;
...
public class LocationPickActivity extends BaseActivity
    ...
    public void initView() {
        ...
        if(RIDE_REQUEST.containsKey("positions")){
            Gson gson=new Gson();
            Type type = new TypeToken<ArrayList<AddedStop>>() {}.getType();
...
//                }
    ...
    @OnClick({R.id.source, R.id.reset_source, R.id.home_address_layout, R.id.work_address_layout,
