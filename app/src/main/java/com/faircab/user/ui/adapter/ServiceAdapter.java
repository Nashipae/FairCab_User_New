...
import static com.faircab.user.base.BaseActivity.getNewNumberFormat;
...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,
        ...
        Glide.with(context)
                .load(obj.getImage())
                .apply(RequestOptions.placeholderOf(R.drawable.car1).dontAnimate().error(R.drawable.car1))
                .into(holder.image);
